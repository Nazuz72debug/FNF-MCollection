...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FNF Multivers Collection", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("FNF Multivers Collection", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "Multiverse Team";
		app.meta["file"] = "FNF Multivers Collection";
		app.meta["name"] = "Friday Night Funkin': Multivers Collection";
		app.meta["packageName"] = "com.shadowmario.psychengine";
		app.meta["version"] = "v0.9";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': Multivers Collection",
			width: 1280,
			x: null,
			y: null,
		};
