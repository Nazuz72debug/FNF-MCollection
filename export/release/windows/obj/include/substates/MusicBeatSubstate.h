...
#define INCLUDED_substates_MusicBeatSubstate
...
class HXCPP_CLASS_ATTRIBUTES MusicBeatSubstate_obj : public  ::flixel::FlxSubState_obj
{
	...
	public:
		enum { _hx_ClassId = 0x249d54f6 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="substates.MusicBeatSubstate")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"substates.MusicBeatSubstate"); }
...
#endif /* INCLUDED_substates_MusicBeatSubstate */ 
