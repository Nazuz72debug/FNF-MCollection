...
#define INCLUDED_substates_GameplayOption
...
class HXCPP_CLASS_ATTRIBUTES GameplayOption_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x10fc4ddd };

		void __construct(::String name,::String variable,::String __o_type, ::Dynamic __o_defaultValue,::Array< ::String > options);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="substates.GameplayOption")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"substates.GameplayOption"); }
...
#endif /* INCLUDED_substates_GameplayOption */ 
