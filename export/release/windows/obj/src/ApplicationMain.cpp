...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("FNF Multivers Collection",17,0f,ad,46),::ApplicationMain_obj::create_dyn());
...
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("Multiverse Team",a1,82,f0,e4));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("FNF Multivers Collection",17,0f,ad,46));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin': Multivers Collection",88,ac,3b,d8));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.shadowmario.psychengine",c6,9e,3e,fb));
HXLINE(  43)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("v0.9",c5,c1,23,4e));
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Friday Night Funkin': Multivers Collection",88,ac,3b,d8))
