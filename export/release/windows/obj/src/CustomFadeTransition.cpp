...
HX_DEFINE_STACK_FRAME(_hx_pos_11636191a51c3638_18_new,"CustomFadeTransition","new",0x93baefd4,"CustomFadeTransition.new","CustomFadeTransition.hx",18,0xa4d2e61c)
...
HX_DEFINE_STACK_FRAME(_hx_pos_11636191a51c3638_48_new,"CustomFadeTransition","new",0x93baefd4,"CustomFadeTransition.new","CustomFadeTransition.hx",48,0xa4d2e61c)
HX_DEFINE_STACK_FRAME(_hx_pos_11636191a51c3638_56_new,"CustomFadeTransition","new",0x93baefd4,"CustomFadeTransition.new","CustomFadeTransition.hx",56,0xa4d2e61c)
HX_LOCAL_STACK_FRAME(_hx_pos_11636191a51c3638_70_update,"CustomFadeTransition","update",0x98488715,"CustomFadeTransition.update","CustomFadeTransition.hx",70,0xa4d2e61c)
HX_LOCAL_STACK_FRAME(_hx_pos_11636191a51c3638_84_destroy,"CustomFadeTransition","destroy",0x2de4166e,"CustomFadeTransition.destroy","CustomFadeTransition.hx",84,0xa4d2e61c)

void CustomFadeTransition_obj::__construct(Float duration,bool isTransIn){
            	HX_GC_STACKFRAME(&_hx_pos_11636191a51c3638_18_new)
HXLINE(  22)		this->isTransIn = false;
HXLINE(  20)		this->leTween = null();
HXLINE(  26)		 ::CustomFadeTransition _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE(  27)		super::__construct();
HXLINE(  29)		this->isTransIn = isTransIn;
HXLINE(  30)		Float zoom = ::Math_obj::max(((Float)0.05),::Math_obj::min(( (Float)(1) ),::flixel::FlxG_obj::camera->zoom));
HXLINE(  31)		int width = ::Std_obj::_hx_int((( (Float)(::flixel::FlxG_obj::width) ) / zoom));
HXLINE(  32)		int height = ::Std_obj::_hx_int((( (Float)(::flixel::FlxG_obj::height) ) / zoom));
HXLINE(  33)		::Array< int > _hx_tmp;
HXDLIN(  33)		if (isTransIn) {
HXLINE(  33)			_hx_tmp = ::Array_obj< int >::fromData( _hx_array_data_00f1b5e2_1,2);
            		}
            		else {
HXLINE(  33)			_hx_tmp = ::Array_obj< int >::fromData( _hx_array_data_00f1b5e2_2,2);
            		}
HXDLIN(  33)		this->transGradient = ::flixel::util::FlxGradient_obj::createGradientFlxSprite(width,height,_hx_tmp,null(),null(),null());
HXLINE(  34)		this->transGradient->scrollFactor->set(null(),null());
HXLINE(  35)		this->add(this->transGradient);
HXLINE(  37)		this->transBlack =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->makeGraphic(width,(height + 400),-16777216,null(),null());
HXLINE(  38)		this->transBlack->scrollFactor->set(null(),null());
HXLINE(  39)		this->add(this->transBlack);
HXLINE(  41)		 ::flixel::FlxSprite fh = this->transGradient;
HXDLIN(  41)		fh->set_x((fh->x - (( (Float)((width - ::flixel::FlxG_obj::width)) ) / ( (Float)(2) ))));
HXLINE(  42)		this->transBlack->set_x(this->transGradient->x);
HXLINE(  44)		if (isTransIn) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::CustomFadeTransition,_gthis) HXARGC(1)
            			void _hx_run( ::flixel::tweens::FlxTween twn){
            				HX_GC_STACKFRAME(&_hx_pos_11636191a51c3638_48_new)
HXLINE(  48)				_gthis->close();
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE(  45)			 ::flixel::FlxSprite _hx_tmp = this->transGradient;
HXDLIN(  45)			Float _hx_tmp1 = this->transBlack->y;
HXDLIN(  45)			_hx_tmp->set_y((_hx_tmp1 - this->transBlack->get_height()));
HXLINE(  46)			 ::flixel::FlxSprite _hx_tmp2 = this->transGradient;
HXDLIN(  46)			Float _hx_tmp3 = (this->transGradient->get_height() + 50);
HXDLIN(  46)			::flixel::tweens::FlxTween_obj::tween(_hx_tmp2, ::Dynamic(::hx::Anon_obj::Create(1)
            			...
            			void _hx_run( ::flixel::tweens::FlxTween twn){
            				HX_GC_STACKFRAME(&_hx_pos_11636191a51c3638_56_new)
HXLINE(  56)				if (::hx::IsNotNull( ::CustomFadeTransition_obj::finishCallback )) {
HXLINE(  57)					::CustomFadeTransition_obj::finishCallback();
            				}
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE(  52)			 ::flixel::FlxSprite _hx_tmp = this->transGradient;
HXDLIN(  52)			_hx_tmp->set_y(-(this->transGradient->get_height()));
HXLINE(  53)			 ::flixel::FlxSprite _hx_tmp1 = this->transBlack;
HXDLIN(  53)			Float _hx_tmp2 = this->transGradient->y;
HXDLIN(  53)			_hx_tmp1->set_y(((_hx_tmp2 - this->transBlack->get_height()) + 50));
HXLINE(  54)			 ::flixel::FlxSprite _hx_tmp3 = this->transGradient;
HXDLIN(  54)			Float _hx_tmp4 = (this->transGradient->get_height() + 50);
HXDLIN(  54)			this->leTween = ::flixel::tweens::FlxTween_obj::tween(_hx_tmp3, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE(  63)		if (::hx::IsNotNull( ::CustomFadeTransition_obj::nextCamera )) {
HXLINE(  64)			this->transBlack->set_cameras(::Array_obj< ::Dynamic>::__new(1)->init(0,::CustomFadeTransition_obj::nextCamera));
HXLINE(  65)			this->transGradient->set_cameras(::Array_obj< ::Dynamic>::__new(1)->init(0,::CustomFadeTransition_obj::nextCamera));
            		}
HXLINE(  67)		::CustomFadeTransition_obj::nextCamera = null();
            	}
...
void CustomFadeTransition_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_11636191a51c3638_70_update)
HXLINE(  71)		if (this->isTransIn) {
HXLINE(  72)			 ::flixel::FlxSprite _hx_tmp = this->transBlack;
HXDLIN(  72)			Float _hx_tmp1 = this->transGradient->y;
HXDLIN(  72)			_hx_tmp->set_y((_hx_tmp1 + this->transGradient->get_height()));
            		}
            		else {
HXLINE(  74)			 ::flixel::FlxSprite _hx_tmp = this->transBlack;
HXDLIN(  74)			Float _hx_tmp1 = this->transGradient->y;
HXDLIN(  74)			_hx_tmp->set_y((_hx_tmp1 - this->transBlack->get_height()));
            		}
HXLINE(  76)		this->super::update(elapsed);
HXLINE(  77)		if (this->isTransIn) {
HXLINE(  78)			 ::flixel::FlxSprite _hx_tmp = this->transBlack;
HXDLIN(  78)			Float _hx_tmp1 = this->transGradient->y;
HXDLIN(  78)			_hx_tmp->set_y((_hx_tmp1 + this->transGradient->get_height()));
            		}
            		else {
HXLINE(  80)			 ::flixel::FlxSprite _hx_tmp = this->transBlack;
HXDLIN(  80)			Float _hx_tmp1 = this->transGradient->y;
HXDLIN(  80)			_hx_tmp->set_y((_hx_tmp1 - this->transBlack->get_height()));
            		}
            	}


void CustomFadeTransition_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_11636191a51c3638_84_destroy)
HXLINE(  85)		if (::hx::IsNotNull( this->leTween )) {
HXLINE(  86)			::CustomFadeTransition_obj::finishCallback();
HXLINE(  87)			this->leTween->cancel();
            		}
