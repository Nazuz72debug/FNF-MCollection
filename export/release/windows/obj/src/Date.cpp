...
HX_DEFINE_STACK_FRAME(_hx_pos_112fe8f7d1d8e3e6_26_new,"Date","new",0x9aa26240,"Date.new","D:\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",26,0x3349c629)
HX_LOCAL_STACK_FRAME(_hx_pos_112fe8f7d1d8e3e6_30_getTime,"Date","getTime",0x0cac7da3,"Date.getTime","D:\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",30,0x3349c629)
HX_LOCAL_STACK_FRAME(_hx_pos_112fe8f7d1d8e3e6_34_getHours,"Date","getHours",0x256fe079,"Date.getHours","D:\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",34,0x3349c629)
HX_LOCAL_STACK_FRAME(_hx_pos_112fe8f7d1d8e3e6_58_getDay,"Date","getDay",0x598d4986,"Date.getDay","D:\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",58,0x3349c629)
HX_LOCAL_STACK_FRAME(_hx_pos_112fe8f7d1d8e3e6_94_toString,"Date","toString",0xd2a372cc,"Date.toString","D:\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",94,0x3349c629)
HX_LOCAL_STACK_FRAME(_hx_pos_112fe8f7d1d8e3e6_98_now,"Date","now",0x9aa26af6,"Date.now","D:\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",98,0x3349c629)
HX_LOCAL_STACK_FRAME(_hx_pos_112fe8f7d1d8e3e6_105_fromTime,"Date","fromTime",0x44fd3cb7,"Date.fromTime","D:\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",105,0x3349c629)
HX_LOCAL_STACK_FRAME(_hx_pos_112fe8f7d1d8e3e6_112_fromString,"Date","fromString",0x5ead97fb,"Date.fromString","D:\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",112,0x3349c629)

void Date_obj::__construct(int year,int month,int day,int hour,int min,int sec){
            	HX_STACKFRAME(&_hx_pos_112fe8f7d1d8e3e6_26_new)
...
Float Date_obj::getTime(){
            	HX_STACKFRAME(&_hx_pos_112fe8f7d1d8e3e6_30_getTime)
...
int Date_obj::getHours(){
            	HX_STACKFRAME(&_hx_pos_112fe8f7d1d8e3e6_34_getHours)
...
int Date_obj::getDay(){
            	HX_STACKFRAME(&_hx_pos_112fe8f7d1d8e3e6_58_getDay)
...
::String Date_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_112fe8f7d1d8e3e6_94_toString)
...
HX_DEFINE_DYNAMIC_FUNC0(Date_obj,toString,return )
 ...
 ::Date Date_obj::now(){
            	HX_STACKFRAME(&_hx_pos_112fe8f7d1d8e3e6_98_now)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Date_obj,now,return )
 ...
 ::Date Date_obj::fromTime(Float t){
            	HX_GC_STACKFRAME(&_hx_pos_112fe8f7d1d8e3e6_105_fromTime)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Date_obj,fromTime,return )
 ...
 ::Date Date_obj::fromString(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_112fe8f7d1d8e3e6_112_fromString)
