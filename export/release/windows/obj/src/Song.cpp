...
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_138_hasDifficulty,"Song","hasDifficulty",0xa31773fc,"Song.hasDifficulty","Song.hx",138,0x775e99e9)
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_155_parseJSONshit,"Song","parseJSONshit",0x7c7ff6e2,"Song.parseJSONshit","Song.hx",155,0x775e99e9)
...
bool Song_obj::hasDifficulty(::String songKey,::String difficulty){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_138_hasDifficulty)
HXLINE( 141)		::String library = null();
HXDLIN( 141)		::String path = ::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + ((songKey + HX_("/",2f,00,00,00)) + difficulty)) + HX_(".json",56,f1,d6,c2)),HX_("TEXT",ad,94,ba,37),library);
HXLINE( 142)		if (!(::sys::FileSystem_obj::exists(path))) {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Song_obj,hasDifficulty,return )

 ::Dynamic Song_obj::parseJSONshit(::String rawJson){
            	HX_GC_STACKFRAME(&_hx_pos_4e288e2989890fc6_155_parseJSONshit)
HXLINE( 156)		 ::Dynamic swagShit =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse()->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic);
HXLINE( 157)		swagShit->__SetField(HX_("validScore",b6,dc,18,c7),true,::hx::paccDynamic);
HXLINE( 158)		return swagShit;
            	}
...
bool Song_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 12:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"hasDifficulty") ) { outValue = hasDifficulty_dyn(); return true; }
