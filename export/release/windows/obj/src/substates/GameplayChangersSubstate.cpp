...
HX_DEFINE_STACK_FRAME(_hx_pos_6d3d9e5dfbdc81cc_30_new,"substates.GameplayChangersSubstate","new",0xfd3a2026,"substates.GameplayChangersSubstate.new","substates/GameplayChangersSubstate.hx",30,0x349481a9)
HX_LOCAL_STACK_FRAME(_hx_pos_6d3d9e5dfbdc81cc_41_getOptions,"substates.GameplayChangersSubstate","getOptions",0x09758e62,"substates.GameplayChangersSubstate.getOptions","substates/GameplayChangersSubstate.hx",41,0x349481a9)
static const ::String _hx_array_data_5399d534_3[] = {
	HX_("multiplicative",96,7a,3f,fa),HX_("constant",64,c1,9d,a5),
};
HX_LOCAL_STACK_FRAME(_hx_pos_6d3d9e5dfbdc81cc_100_getOptionByName,"substates.GameplayChangersSubstate","getOptionByName",0xb2792f93,"substates.GameplayChangersSubstate.getOptionByName","substates/GameplayChangersSubstate.hx",100,0x349481a9)
HX_LOCAL_STACK_FRAME(_hx_pos_6d3d9e5dfbdc81cc_169_update,"substates.GameplayChangersSubstate","update",0xd89ad603,"substates.GameplayChangersSubstate.update","substates/GameplayChangersSubstate.hx",169,0x349481a9)
HX_LOCAL_STACK_FRAME(_hx_pos_6d3d9e5dfbdc81cc_331_updateTextFrom,"substates.GameplayChangersSubstate","updateTextFrom",0x69a4c5da,"substates.GameplayChangersSubstate.updateTextFrom","substates/GameplayChangersSubstate.hx",331,0x349481a9)
HX_LOCAL_STACK_FRAME(_hx_pos_6d3d9e5dfbdc81cc_340_clearHold,"substates.GameplayChangersSubstate","clearHold",0xaf7919b2,"substates.GameplayChangersSubstate.clearHold","substates/GameplayChangersSubstate.hx",340,0x349481a9)
HX_LOCAL_STACK_FRAME(_hx_pos_6d3d9e5dfbdc81cc_348_changeSelection,"substates.GameplayChangersSubstate","changeSelection",0x60377982,"substates.GameplayChangersSubstate.changeSelection","substates/GameplayChangersSubstate.hx",348,0x349481a9)
HX_LOCAL_STACK_FRAME(_hx_pos_6d3d9e5dfbdc81cc_377_reloadCheckboxes,"substates.GameplayChangersSubstate","reloadCheckboxes",0xbf4daea4,"substates.GameplayChangersSubstate.reloadCheckboxes","substates/GameplayChangersSubstate.hx",377,0x349481a9)
namespace substates{

void GameplayChangersSubstate_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_6d3d9e5dfbdc81cc_30_new)
...
HXLINE( 158)				this->updateTextFrom(( ( ::substates::GameplayOption)(this->optionsArray->__get(i)) ));
            			}
            		}
...
void GameplayChangersSubstate_obj::getOptions(){
            	HX_GC_STACKFRAME(&_hx_pos_6d3d9e5dfbdc81cc_41_getOptions)
HXLINE(  42)		 ::substates::GameplayOption goption =  ::substates::GameplayOption_obj::__alloc( HX_CTX ,HX_("Scroll Type",ad,1f,97,3f),HX_("scrolltype",47,55,ef,1f),HX_("string",d1,28,30,11),HX_("multiplicative",96,7a,3f,fa),::Array_obj< ::String >::fromData( _hx_array_data_5399d534_3,2));
HXLINE(  43)		this->optionsArray->push(goption);
HXLINE(  45)		 ::substates::GameplayOption option =  ::substates::GameplayOption_obj::__alloc( HX_CTX ,HX_("Scroll Speed",34,bf,42,cb),HX_("scrollspeed",5a,70,19,38),HX_("float",9c,c5,96,02),1,null());
...
HXLINE(  63)		 ::substates::GameplayOption option1 =  ::substates::GameplayOption_obj::__alloc( HX_CTX ,HX_("Playback Rate",05,cb,36,2d),HX_("songspeed",92,6f,b6,1d),HX_("float",9c,c5,96,02),1,null());
...
HXLINE(  73)		 ::substates::GameplayOption option2 =  ::substates::GameplayOption_obj::__alloc( HX_CTX ,HX_("Health Gain Multiplier",1e,c6,e7,2f),HX_("healthgain",1b,97,1b,16),HX_("float",9c,c5,96,02),1,null());
...
HXLINE(  81)		 ::substates::GameplayOption option3 =  ::substates::GameplayOption_obj::__alloc( HX_CTX ,HX_("Health Loss Multiplier",3a,7f,8e,c0),HX_("healthloss",7f,50,74,19),HX_("float",9c,c5,96,02),1,null());
...
HXLINE(  89)		 ::substates::GameplayOption option4 =  ::substates::GameplayOption_obj::__alloc( HX_CTX ,HX_("Instakill on Miss",76,d5,a0,bc),HX_("instakill",f9,72,23,49),HX_("bool",2a,84,1b,41),false,null());
HXLINE(  90)		this->optionsArray->push(option4);
HXLINE(  92)		 ::substates::GameplayOption option5 =  ::substates::GameplayOption_obj::__alloc( HX_CTX ,HX_("Practice Mode",e8,58,72,66),HX_("practice",bb,00,e7,a0),HX_("bool",2a,84,1b,41),false,null());
HXLINE(  93)		this->optionsArray->push(option5);
HXLINE(  95)		 ::substates::GameplayOption option6 =  ::substates::GameplayOption_obj::__alloc( HX_CTX ,HX_("Botplay",5b,23,fb,2e),HX_("botplay",7b,fb,a9,61),HX_("bool",2a,84,1b,41),false,null());
...
HX_DEFINE_DYNAMIC_FUNC0(GameplayChangersSubstate_obj,getOptions,(void))
 ...
 ::substates::GameplayOption GameplayChangersSubstate_obj::getOptionByName(::String name){
            	HX_STACKFRAME(&_hx_pos_6d3d9e5dfbdc81cc_100_getOptionByName)
HXLINE( 101)		{
HXLINE( 101)			int _g = 0;
...
HXDLIN( 101)				_g = (_g + 1);
HXLINE( 103)				 ::substates::GameplayOption opt = ( ( ::substates::GameplayOption)(i) );
...
void GameplayChangersSubstate_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_6d3d9e5dfbdc81cc_169_update)
...
HXLINE( 198)					 ::substates::GameplayOption _hx_tmp1 = this->curOption;
...
HXLINE( 246)									 ::substates::GameplayOption oOption = this->getOptionByName(HX_("Scroll Speed",34,bf,42,cb));
...
HXLINE( 278)									 ::substates::GameplayOption _hx_tmp = this->curOption;
...
HXLINE( 286)						 ::substates::GameplayChangersSubstate _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 297)						 ::substates::GameplayOption leOption = ( ( ::substates::GameplayOption)(this->optionsArray->__get(i)) );
...
HXLINE( 326)			 ::substates::GameplayChangersSubstate _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
...
void GameplayChangersSubstate_obj::updateTextFrom( ::substates::GameplayOption option){
            	HX_STACKFRAME(&_hx_pos_6d3d9e5dfbdc81cc_331_updateTextFrom)
...
void GameplayChangersSubstate_obj::clearHold(){
            	HX_STACKFRAME(&_hx_pos_6d3d9e5dfbdc81cc_340_clearHold)
...
void GameplayChangersSubstate_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_6d3d9e5dfbdc81cc_348_changeSelection)
HXLINE( 349)		 ::substates::GameplayChangersSubstate _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 372)		this->curOption = ( ( ::substates::GameplayOption)(this->optionsArray->__get(this->curSelected)) );
...
void GameplayChangersSubstate_obj::reloadCheckboxes(){
            	HX_GC_STACKFRAME(&_hx_pos_6d3d9e5dfbdc81cc_377_reloadCheckboxes)
