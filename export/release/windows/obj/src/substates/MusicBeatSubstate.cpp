...
HX_DEFINE_STACK_FRAME(_hx_pos_a2306406ae38e7da_9_new,"substates.MusicBeatSubstate","new",0xa0987892,"substates.MusicBeatSubstate.new","substates/MusicBeatSubstate.hx",9,0x8beea59f)
HX_LOCAL_STACK_FRAME(_hx_pos_a2306406ae38e7da_27_get_controls,"substates.MusicBeatSubstate","get_controls",0x9147fc0d,"substates.MusicBeatSubstate.get_controls","substates/MusicBeatSubstate.hx",27,0x8beea59f)
HX_LOCAL_STACK_FRAME(_hx_pos_a2306406ae38e7da_30_update,"substates.MusicBeatSubstate","update",0x96268917,"substates.MusicBeatSubstate.update","substates/MusicBeatSubstate.hx",30,0x8beea59f)
HX_LOCAL_STACK_FRAME(_hx_pos_a2306406ae38e7da_45_updateBeat,"substates.MusicBeatSubstate","updateBeat",0xf0c36e2d,"substates.MusicBeatSubstate.updateBeat","substates/MusicBeatSubstate.hx",45,0x8beea59f)
HX_LOCAL_STACK_FRAME(_hx_pos_a2306406ae38e7da_51_updateCurStep,"substates.MusicBeatSubstate","updateCurStep",0xc1f75895,"substates.MusicBeatSubstate.updateCurStep","substates/MusicBeatSubstate.hx",51,0x8beea59f)
HX_LOCAL_STACK_FRAME(_hx_pos_a2306406ae38e7da_61_stepHit,"substates.MusicBeatSubstate","stepHit",0xaf035799,"substates.MusicBeatSubstate.stepHit","substates/MusicBeatSubstate.hx",61,0x8beea59f)
HX_LOCAL_STACK_FRAME(_hx_pos_a2306406ae38e7da_66_beatHit,"substates.MusicBeatSubstate","beatHit",0xa1c693af,"substates.MusicBeatSubstate.beatHit","substates/MusicBeatSubstate.hx",66,0x8beea59f)
namespace substates{

void MusicBeatSubstate_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_a2306406ae38e7da_9_new)
...
bool MusicBeatSubstate_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Controls MusicBeatSubstate_obj::get_controls(){
            	HX_STACKFRAME(&_hx_pos_a2306406ae38e7da_27_get_controls)
...
void MusicBeatSubstate_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_a2306406ae38e7da_30_update)
...
void MusicBeatSubstate_obj::updateBeat(){
            	HX_STACKFRAME(&_hx_pos_a2306406ae38e7da_45_updateBeat)
...
void MusicBeatSubstate_obj::updateCurStep(){
            	HX_STACKFRAME(&_hx_pos_a2306406ae38e7da_51_updateCurStep)
...
void MusicBeatSubstate_obj::stepHit(){
            	HX_STACKFRAME(&_hx_pos_a2306406ae38e7da_61_stepHit)
...
void MusicBeatSubstate_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_a2306406ae38e7da_66_beatHit)
            	}
...
::hx::ObjectPtr< MusicBeatSubstate_obj > MusicBeatSubstate_obj::__alloc(::hx::Ctx *_hx_ctx) {
	MusicBeatSubstate_obj *__this = (MusicBeatSubstate_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(MusicBeatSubstate_obj), true, "substates.MusicBeatSubstate"));
...
void MusicBeatSubstate_obj::__register()
{
	...
	__mClass->mName = HX_("substates.MusicBeatSubstate",a0,87,70,d1);
