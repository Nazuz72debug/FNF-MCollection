...
HX_DEFINE_STACK_FRAME(_hx_pos_e5abf8620039da0e_22_new,"DiscordClient","new",0xa1a2b969,"DiscordClient.new","Discord.hx",22,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_44_shutdown,"DiscordClient","shutdown",0x0f46b2ed,"DiscordClient.shutdown","Discord.hx",44,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_49_onReady,"DiscordClient","onReady",0x690ae04d,"DiscordClient.onReady","Discord.hx",49,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_59_onError,"DiscordClient","onError",0xf57a0bb2,"DiscordClient.onError","Discord.hx",59,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_64_onDisconnected,"DiscordClient","onDisconnected",0xa84d7d11,"DiscordClient.onDisconnected","Discord.hx",64,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_71_initialize,"DiscordClient","initialize",0x1dd16b67,"DiscordClient.initialize","Discord.hx",71,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_68_initialize,"DiscordClient","initialize",0x1dd16b67,"DiscordClient.initialize","Discord.hx",68,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_78_changePresence,"DiscordClient","changePresence",0xb0052162,"DiscordClient.changePresence","Discord.hx",78,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_103_addLuaCallbacks,"DiscordClient","addLuaCallbacks",0x51cfc080,"DiscordClient.addLuaCallbacks","Discord.hx",103,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_102_addLuaCallbacks,"DiscordClient","addLuaCallbacks",0x51cfc080,"DiscordClient.addLuaCallbacks","Discord.hx",102,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_20_boot,"DiscordClient","boot",0xc4d88309,"DiscordClient.boot","Discord.hx",20,0xa6c9e0b2)

void DiscordClient_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_22_new)
HXLINE(  23)		::haxe::Log_obj::trace(HX_("Discord Client starting...",0d,5b,39,a8),::hx::SourceInfo(HX_("source/Discord.hx",a6,a8,2e,33),23,HX_("DiscordClient",f7,d0,c5,2b),HX_("new",60,d0,53,00)));
HXLINE(  24)		::discord_rpc::DiscordRpc_obj::start( ::Dynamic(::hx::Anon_obj::Create(4)
            			...
            			->setFixed(2,HX_("clientID",e6,72,8f,15),HX_("1387894386049814528",b6,3f,44,31))
            			->setFixed(3,HX_("onReady",c4,3e,f8,7c),::DiscordClient_obj::onReady_dyn())));
HXLINE(  30)		::haxe::Log_obj::trace(HX_("Discord Client started.",8e,09,8e,36),::hx::SourceInfo(HX_("source/Discord.hx",a6,a8,2e,33),30,HX_("DiscordClient",f7,d0,c5,2b),HX_("new",60,d0,53,00)));
HXLINE(  32)		while(true){
HXLINE(  34)			::discord_rpc::DiscordRpc_obj::process();
HXLINE(  35)			::Sys_obj::sleep(( (Float)(2) ));
            		}
            	}
...
void DiscordClient_obj::shutdown(){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_44_shutdown)
HXDLIN(  44)		::discord_rpc::DiscordRpc_obj::shutdown();
            	}
...
void DiscordClient_obj::onReady(){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_49_onReady)
HXDLIN(  49)		::discord_rpc::DiscordRpc_obj::presence( ::Dynamic(::hx::Anon_obj::Create(4)
            			->setFixed(0,HX_("state",11,76,0b,84),null())
            			->setFixed(1,HX_("details",c2,dc,56,ab),HX_("Dans le Menus",ab,8f,79,7d))
            			->setFixed(2,HX_("largeImageKey",df,8f,e3,ae),HX_("mc-logo",02,03,b8,7a))
            			->setFixed(3,HX_("largeImageText",6d,3e,2d,5e),HX_("Multiverse Colection",ee,44,97,17))));
            	}
...
void DiscordClient_obj::onError(int _code,::String _message){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_59_onError)
HXDLIN(  59)		::haxe::Log_obj::trace((((HX_("Error! ",87,92,5b,b7) + _code) + HX_(" : ",c6,7a,18,00)) + _message),::hx::SourceInfo(HX_("source/Discord.hx",a6,a8,2e,33),59,HX_("DiscordClient",f7,d0,c5,2b),HX_("onError",29,6a,67,09)));
            	}
...
void DiscordClient_obj::onDisconnected(int _code,::String _message){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_64_onDisconnected)
HXDLIN(  64)		::haxe::Log_obj::trace((((HX_("Disconnected! ",7a,e1,87,53) + _code) + HX_(" : ",c6,7a,18,00)) + _message),::hx::SourceInfo(HX_("source/Discord.hx",a6,a8,2e,33),64,HX_("DiscordClient",f7,d0,c5,2b),HX_("onDisconnected",7a,eb,5a,b8)));
            	}
...
void DiscordClient_obj::initialize(){
            		...
            		void _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_e5abf8620039da0e_71_initialize)
HXLINE(  71)			 ::DiscordClient_obj::__alloc( HX_CTX );
            		}
            		HX_END_LOCAL_FUNC0((void))

            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_68_initialize)
HXLINE(  69)		 ::sys::thread::_Thread::HaxeThread DiscordDaemon = ::sys::thread::_Thread::HaxeThread_obj::create( ::Dynamic(new _hx_Closure_0()),false);
HXLINE(  73)		::haxe::Log_obj::trace(HX_("Discord Client initialized",f3,a9,32,06),::hx::SourceInfo(HX_("source/Discord.hx",a6,a8,2e,33),73,HX_("DiscordClient",f7,d0,c5,2b),HX_("initialize",50,31,bb,ec)));
HXLINE(  74)		::DiscordClient_obj::isInitialized = true;
            	}
...
void DiscordClient_obj::changePresence(::String details,::String state,::String smallImageKey, ::Dynamic hasStartTimestamp, ::Dynamic endTimestamp){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_78_changePresence)
HXLINE(  79)		Float startTimestamp;
HXDLIN(  79)		if (( (bool)(hasStartTimestamp) )) {
HXLINE(  79)			startTimestamp = ::Date_obj::now()->getTime();
            		}
            		else {
HXLINE(  79)			startTimestamp = ( (Float)(0) );
            		}
HXLINE(  81)		if (::hx::IsGreater( endTimestamp,0 )) {
HXLINE(  83)			endTimestamp = (startTimestamp + endTimestamp);
            		}
HXLINE(  90)		::String _hx_tmp = (HX_("Engine Version: ",e0,15,79,71) + ::states::MainMenuState_obj::psychEngineVersion);
HXLINE(  93)		 ::Dynamic _hx_tmp1 = ::Std_obj::_hx_int((startTimestamp / ( (Float)(1000) )));
HXLINE(  86)		::discord_rpc::DiscordRpc_obj::presence( ::Dynamic(::hx::Anon_obj::Create(7)
            			...
            			->setFixed(3,HX_("largeImageKey",df,8f,e3,ae),HX_("mc-logo",02,03,b8,7a))
...
void DiscordClient_obj::addLuaCallbacks( cpp::Reference<lua_State> lua){
            		...
            		void _hx_run(::String details,::String state,::String smallImageKey, ::Dynamic hasStartTimestamp, ::Dynamic endTimestamp){
            			HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_103_addLuaCallbacks)
HXLINE( 103)			::DiscordClient_obj::changePresence(details,state,smallImageKey,hasStartTimestamp,endTimestamp);
            		}
            		HX_END_LOCAL_FUNC5((void))

            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_102_addLuaCallbacks)
HXDLIN( 102)		::llua::Lua_helper_obj::callbacks->set(HX_("changePresence",cb,8f,12,c0), ::Dynamic(new _hx_Closure_0()));
HXDLIN( 102)		linc::callbacks::add_callback_function(lua,HX_("changePresence",cb,8f,12,c0));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_20_boot)
HXDLIN(  20)		isInitialized = false;
            	}
}
