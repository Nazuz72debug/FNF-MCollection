...
HX_DEFINE_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_3339_new,"DebugLuaText","new",0xad824284,"DebugLuaText.new","FunkinLua.hx",3339,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_3351_update,"DebugLuaText","update",0x3cb60265,"DebugLuaText.update","FunkinLua.hx",3351,0x00117937)

void DebugLuaText_obj::__construct(::String text, ::flixel::group::FlxTypedGroup parentGroup,int color){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_3339_new)
HXLINE(3341)		this->disableTime = ((Float)6);
HXLINE(3344)		this->parentGroup = parentGroup;
HXLINE(3345)		super::__construct(10,10,0,text,16,null());
HXLINE(3346)		::String file = ::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82)));
HXDLIN(3346)		::String _hx_tmp;
HXDLIN(3346)		if (::sys::FileSystem_obj::exists(file)) {
HXLINE(3346)			_hx_tmp = file;
            		}
            		else {
HXLINE(3346)			_hx_tmp = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN(3346)		this->setFormat(_hx_tmp,20,color,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(3347)		this->scrollFactor->set(null(),null());
HXLINE(3348)		this->set_borderSize(( (Float)(1) ));
            	}
...
void DebugLuaText_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_3351_update)
HXLINE(3352)		this->super::update(elapsed);
HXLINE(3353)		 ::DebugLuaText _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(3353)		_hx_tmp->disableTime = (_hx_tmp->disableTime - elapsed);
HXLINE(3354)		if ((this->disableTime < 0)) {
HXLINE(3354)			this->disableTime = ( (Float)(0) );
            		}
HXLINE(3355)		if ((this->disableTime < 1)) {
HXLINE(3355)			this->set_alpha(this->disableTime);
            		}
            	}
