...
HX_DEFINE_STACK_FRAME(_hx_pos_aa1a162bced268b8_30_new,"editors.MasterEditorMenu","new",0xa289ac88,"editors.MasterEditorMenu.new","editors/MasterEditorMenu.hx",30,0x3933e087)
...
HX_LOCAL_STACK_FRAME(_hx_pos_aa1a162bced268b8_48_create,"editors.MasterEditorMenu","create",0xee5b93d4,"editors.MasterEditorMenu.create","editors/MasterEditorMenu.hx",48,0x3933e087)
HX_LOCAL_STACK_FRAME(_hx_pos_aa1a162bced268b8_98_update,"editors.MasterEditorMenu","update",0xf951b2e1,"editors.MasterEditorMenu.update","editors/MasterEditorMenu.hx",98,0x3933e087)
HX_LOCAL_STACK_FRAME(_hx_pos_aa1a162bced268b8_164_changeSelection,"editors.MasterEditorMenu","changeSelection",0x385910e4,"editors.MasterEditorMenu.changeSelection","editors/MasterEditorMenu.hx",164,0x3933e087)
HX_LOCAL_STACK_FRAME(_hx_pos_aa1a162bced268b8_177_changeDirectory,"editors.MasterEditorMenu","changeDirectory",0xba830b05,"editors.MasterEditorMenu.changeDirectory","editors/MasterEditorMenu.hx",177,0x3933e087)
namespace editors{
...
void MasterEditorMenu_obj::__construct( ::flixel::addons::transition::TransitionData TransIn, ::flixel::addons::transition::TransitionData TransOut){
            	HX_STACKFRAME(&_hx_pos_aa1a162bced268b8_30_new)
HXLINE(  44)		this->curDirectory = 0;
HXLINE(  43)		this->curSelected = 0;
HXLINE(  41)		this->directories = ::Array_obj< ::String >::__new(1)->init(0,null());
HXLINE(  32)		this->options = ::Array_obj< ::String >::fromData( _hx_array_data_7d8f0896_1,6);
...
void MasterEditorMenu_obj::create(){
            	HX_GC_STACKFRAME(&_hx_pos_aa1a162bced268b8_48_create)
HXLINE(  49)		::flixel::FlxG_obj::camera->bgColor = -16777216;
HXLINE(  52)		::DiscordClient_obj::changePresence(HX_("Editors Main Menu",4c,98,82,a7),null(),null(),null(),null());
HXLINE(  55)		 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null());
HXDLIN(  55)		::String library = null();
HXDLIN(  55)		 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("menuDesat",26,91,04,72),library);
HXDLIN(  55)		 ::flixel::FlxSprite bg1 = bg->loadGraphic(returnAsset,null(),null(),null(),null(),null());
HXLINE(  56)		bg1->scrollFactor->set(null(),null());
HXLINE(  57)		bg1->set_color(-13290187);
HXLINE(  58)		this->add(bg1);
HXLINE(  60)		this->grpTexts =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
HXLINE(  61)		this->add(this->grpTexts);
HXLINE(  63)		{
HXLINE(  63)			int _g = 0;
HXDLIN(  63)			int _g1 = this->options->length;
HXDLIN(  63)			while((_g < _g1)){
HXLINE(  63)				_g = (_g + 1);
HXDLIN(  63)				int i = (_g - 1);
HXLINE(  65)				 ::Alphabet leText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(90) ),( (Float)(320) ),this->options->__get(i),true);
HXLINE(  66)				leText->isMenuItem = true;
HXLINE(  67)				leText->targetY = i;
HXLINE(  68)				this->grpTexts->add(leText).StaticCast<  ::Alphabet >();
HXLINE(  69)				leText->snapToPosition();
            			}
            		}
HXLINE(  73)		 ::flixel::FlxSprite textBG =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,(::flixel::FlxG_obj::height - 42),null())->makeGraphic(::flixel::FlxG_obj::width,42,-16777216,null(),null());
HXLINE(  74)		textBG->set_alpha(((Float)0.6));
HXLINE(  75)		this->add(textBG);
HXLINE(  77)		this->directoryTxt =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,textBG->x,(textBG->y + 4),::flixel::FlxG_obj::width,HX_("",00,00,00,00),32,null());
HXLINE(  78)		 ::flixel::text::FlxText _hx_tmp = this->directoryTxt;
HXDLIN(  78)		::String file = ::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82)));
HXDLIN(  78)		::String _hx_tmp1;
HXDLIN(  78)		if (::sys::FileSystem_obj::exists(file)) {
HXLINE(  78)			_hx_tmp1 = file;
            		}
            		else {
HXLINE(  78)			_hx_tmp1 = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN(  78)		_hx_tmp->setFormat(_hx_tmp1,32,-1,HX_("center",d5,25,db,05),null(),null(),null());
HXLINE(  79)		this->directoryTxt->scrollFactor->set(null(),null());
HXLINE(  80)		this->add(this->directoryTxt);
HXLINE(  82)		{
HXLINE(  82)			int _g2 = 0;
HXDLIN(  82)			::Array< ::String > _g3 = ::Paths_obj::getModDirectories();
HXDLIN(  82)			while((_g2 < _g3->length)){
HXLINE(  82)				::String folder = _g3->__get(_g2);
HXDLIN(  82)				_g2 = (_g2 + 1);
HXLINE(  84)				this->directories->push(folder);
            			}
            		}
HXLINE(  87)		int found = this->directories->indexOf(::Paths_obj::currentModDirectory,null());
HXLINE(  88)		if ((found > -1)) {
HXLINE(  88)			this->curDirectory = found;
            		}
HXLINE(  89)		this->changeDirectory(null());
HXLINE(  91)		this->changeSelection(null());
HXLINE(  93)		::flixel::FlxG_obj::mouse->set_visible(false);
HXLINE(  94)		this->super::create();
            	}


void MasterEditorMenu_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_aa1a162bced268b8_98_update)
...
HXLINE( 108)		if (::PlayerSettings_obj::player1->controls->_ui_leftP->check()) {
HXLINE( 110)			this->changeDirectory(-1);
            		}
HXLINE( 112)		if (::PlayerSettings_obj::player1->controls->_ui_rightP->check()) {
HXLINE( 114)			this->changeDirectory(1);
            		}
HXLINE( 118)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE( 120)			::states::MusicBeatState_obj::switchState( ::states::MainMenuState_obj::__alloc( HX_CTX ,null(),null()));
            		}
HXLINE( 123)		if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE( 125)			::String _hx_switch_0 = this->options->__get(this->curSelected);
            			if (  (_hx_switch_0==HX_("Character Editor",84,45,58,b1)) ){
HXLINE( 127)				::states::MusicBeatState_obj::switchState(::states::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::editors::CharacterEditorState_obj::__alloc( HX_CTX ,::Character_obj::DEFAULT_CHARACTER,false)) ),false));
HXDLIN( 127)				goto _hx_goto_5;
            			}
            			if (  (_hx_switch_0==HX_("Chart Editor",ef,b4,29,e9)) ){
HXLINE( 137)				::states::MusicBeatState_obj::switchState(::states::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::editors::ChartingState_obj::__alloc( HX_CTX ,null(),null())) ),false));
HXDLIN( 137)				goto _hx_goto_5;
            			}
            			if (  (_hx_switch_0==HX_("Dialogue Editor",b5,bb,62,71)) ){
HXLINE( 135)				::states::MusicBeatState_obj::switchState(::states::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::editors::DialogueEditorState_obj::__alloc( HX_CTX ,null(),null())) ),false));
HXDLIN( 135)				goto _hx_goto_5;
            			}
            			if (  (_hx_switch_0==HX_("Dialogue Portrait Editor",ea,22,45,b5)) ){
HXLINE( 133)				::states::MusicBeatState_obj::switchState(::states::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::editors::DialogueCharacterEditorState_obj::__alloc( HX_CTX ,null(),null())) ),false));
HXDLIN( 133)				goto _hx_goto_5;
            			}
            			if (  (_hx_switch_0==HX_("Menu Character Editor",05,2d,60,f9)) ){
HXLINE( 131)				::states::MusicBeatState_obj::switchState( ::editors::MenuCharacterEditorState_obj::__alloc( HX_CTX ,null(),null()));
HXDLIN( 131)				goto _hx_goto_5;
            			}
            			if (  (_hx_switch_0==HX_("Week Editor",59,6c,6c,6d)) ){
HXLINE( 129)				::states::MusicBeatState_obj::switchState( ::editors::WeekEditorState_obj::__alloc( HX_CTX ,null()));
HXDLIN( 129)				goto _hx_goto_5;
            			}
            			_hx_goto_5:;
HXLINE( 139)			::flixel::FlxG_obj::sound->music->set_volume(( (Float)(0) ));
HXLINE( 141)			::states::FreeplayState_obj::destroyFreeplayVocals();
            		}
HXLINE( 145)		int bullShit = 0;
HXLINE( 146)		{
HXLINE( 146)			int _g = 0;
HXDLIN( 146)			::Array< ::Dynamic> _g1 = this->grpTexts->members;
HXDLIN( 146)			while((_g < _g1->length)){
HXLINE( 146)				 ::Alphabet item = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 146)				_g = (_g + 1);
HXLINE( 148)				item->targetY = (bullShit - this->curSelected);
HXLINE( 149)				bullShit = (bullShit + 1);
HXLINE( 151)				item->set_alpha(((Float)0.6));
HXLINE( 154)				if ((item->targetY == 0)) {
HXLINE( 156)					item->set_alpha(( (Float)(1) ));
            				}
            			}
            		}
...
void MasterEditorMenu_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_aa1a162bced268b8_164_changeSelection)
...
HXLINE( 167)		 ::editors::MasterEditorMenu _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 167)		_hx_tmp1->curSelected = (_hx_tmp1->curSelected + change);
HXLINE( 169)		if ((this->curSelected < 0)) {
HXLINE( 170)			this->curSelected = (this->options->length - 1);
            		}
HXLINE( 171)		if ((this->curSelected >= this->options->length)) {
HXLINE( 172)			this->curSelected = 0;
            		}
            	}
...
void MasterEditorMenu_obj::changeDirectory(::hx::Null< int >  __o_change){
            		int change = __o_change.Default(0);
            	HX_STACKFRAME(&_hx_pos_aa1a162bced268b8_177_changeDirectory)
HXLINE( 178)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 178)		_hx_tmp->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),((Float)0.4),null(),null(),null(),null());
HXLINE( 180)		 ::editors::MasterEditorMenu _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 180)		_hx_tmp1->curDirectory = (_hx_tmp1->curDirectory + change);
HXLINE( 182)		if ((this->curDirectory < 0)) {
HXLINE( 183)			this->curDirectory = (this->directories->length - 1);
            		}
HXLINE( 184)		if ((this->curDirectory >= this->directories->length)) {
HXLINE( 185)			this->curDirectory = 0;
            		}
HXLINE( 187)		::WeekData_obj::setDirectoryFromWeek(null());
HXLINE( 188)		bool _hx_tmp2;
HXDLIN( 188)		if (::hx::IsNotNull( this->directories->__get(this->curDirectory) )) {
HXLINE( 188)			_hx_tmp2 = (this->directories->__get(this->curDirectory).length < 1);
            		}
            		else {
HXLINE( 188)			_hx_tmp2 = true;
            		}
HXDLIN( 188)		if (_hx_tmp2) {
HXLINE( 189)			this->directoryTxt->set_text(HX_("< No Mod Directory Loaded >",6f,05,c4,e1));
            		}
            		else {
HXLINE( 192)			::Paths_obj::currentModDirectory = this->directories->__get(this->curDirectory);
HXLINE( 193)			this->directoryTxt->set_text(((HX_("< Loaded Mod Directory: ",1e,b9,7b,3e) + ::Paths_obj::currentModDirectory) + HX_(" >",1e,1c,00,00)));
            		}
HXLINE( 195)		 ::flixel::text::FlxText _hx_tmp3 = this->directoryTxt;
HXDLIN( 195)		_hx_tmp3->set_text(this->directoryTxt->text.toUpperCase());
            	}
