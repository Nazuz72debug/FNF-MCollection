...
#endif
#ifndef INCLUDED___ASSET__OPENFL__mods_fonts_aller_bd_ttf
#include <__ASSET__OPENFL__mods_fonts_aller_bd_ttf.h>
#endif
#ifndef INCLUDED___ASSET__OPENFL__mods_fonts_fnf_ttf
#include <__ASSET__OPENFL__mods_fonts_fnf_ttf.h>
#endif
#ifndef INCLUDED___ASSET__OPENFL__mods_fonts_fnff_ttf
#include <__ASSET__OPENFL__mods_fonts_fnff_ttf.h>
#endif
#ifndef INCLUDED___ASSET__OPENFL__mods_fonts_kabel_bold_ttf
#include <__ASSET__OPENFL__mods_fonts_kabel_bold_ttf.h>
#endif
#ifndef INCLUDED___ASSET__OPENFL__mods_fonts_kabel_heavy_heavy_ttf
#include <__ASSET__OPENFL__mods_fonts_kabel_heavy_heavy_ttf.h>
#endif
#ifndef INCLUDED___ASSET__OPENFL__mods_fonts_smashfont_ttf
#include <__ASSET__OPENFL__mods_fonts_smashfont_ttf.h>
#endif
...
HXLINE(  70)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__mods_fonts_aller_bd_ttf >());
HXLINE(  71)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__mods_fonts_fnf_ttf >());
HXLINE(  72)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__mods_fonts_fnff_ttf >());
HXLINE(  73)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__mods_fonts_kabel_bold_ttf >());
HXLINE(  74)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__mods_fonts_kabel_heavy_heavy_ttf >());
HXLINE(  75)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__mods_fonts_smashfont_ttf >());
HXLINE(  76)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_pixel_otf >());
HXLINE(  77)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_vcr_ttf >());
HXLINE(  78)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf >());
HXLINE(  79)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__flixel_fonts_monsterrat_ttf >());
HXLINE(  83)		 ::Dynamic bundle;
HXLINE(  96)		{
HXLINE(  96)			::String v = (::ManifestResources_obj::rootPath + HX_("manifest/videos.json",1e,f9,65,67));
HXDLIN(  96)			::lime::utils::Assets_obj::libraryPaths->set(HX_("videos",98,d7,95,e5),v);
            		}
HXLINE(  83)		::String data = HX_("{\"name\":null,\"assets\":\"ah\",\"rootPath\":null,\"version\":2,\"libraryArgs\":[],\"libraryType\":null}",6c,e1,75,d6);
HXDLIN(  83)		 ::lime::utils::AssetManifest manifest = ::lime::utils::AssetManifest_obj::parse(data,::ManifestResources_obj::rootPath);
HXDLIN(  83)		 ::lime::utils::AssetLibrary library = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
HXLINE( 100)		::lime::utils::Assets_obj::registerLibrary(HX_("images",b8,50,92,fe),library);
HXLINE( 101)		{
HXLINE( 101)			::String v1 = (::ManifestResources_obj::rootPath + HX_("manifest/songs.json",38,27,75,ee));
HXDLIN( 101)			::lime::utils::Assets_obj::libraryPaths->set(HX_("songs",fe,36,c7,80),v1);
            		}
HXLINE( 102)		{
HXLINE( 102)			::String v2 = (::ManifestResources_obj::rootPath + HX_("manifest/shared.json",f1,c2,0a,f4));
HXDLIN( 102)			::lime::utils::Assets_obj::libraryPaths->set(HX_("shared",a5,5e,2b,1d),v2);
            		}
HXLINE( 103)		{
HXLINE( 103)			::String v3 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN( 103)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v3);
            		}
HXLINE( 106)		library = ::lime::utils::Assets_obj::getLibrary(HX_("videos",98,d7,95,e5));
HXLINE( 107)		if (::hx::IsNotNull( library )) {
HXLINE( 107)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 108)			::ManifestResources_obj::preloadLibraryNames->push(HX_("videos",98,d7,95,e5));
            		}
HXLINE( 109)		library = ::lime::utils::Assets_obj::getLibrary(HX_("images",b8,50,92,fe));
HXLINE( 110)		if (::hx::IsNotNull( library )) {
HXLINE( 110)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 111)			::ManifestResources_obj::preloadLibraryNames->push(HX_("images",b8,50,92,fe));
            		}
HXLINE( 112)		library = ::lime::utils::Assets_obj::getLibrary(HX_("songs",fe,36,c7,80));
HXLINE( 113)		if (::hx::IsNotNull( library )) {
HXLINE( 113)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 114)			::ManifestResources_obj::preloadLibraryNames->push(HX_("songs",fe,36,c7,80));
            		}
HXLINE( 115)		library = ::lime::utils::Assets_obj::getLibrary(HX_("shared",a5,5e,2b,1d));
HXLINE( 116)		if (::hx::IsNotNull( library )) {
HXLINE( 116)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 117)			::ManifestResources_obj::preloadLibraryNames->push(HX_("shared",a5,5e,2b,1d));
            		}
