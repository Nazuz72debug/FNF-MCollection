...
HXLINE( 133)		errMsg = (errMsg + ((HX_("\nUncaught Error: ",ed,bf,e1,72) + ::Std_obj::string(e->error)) + HX_W(u"\nSi cette erreur s\'est produite, v\u00e9rifie les logs ou le Debug Build.\n\n> Crash Handler \u00e9crit par: sqirra-rng",0904,1b5c)));
...
HXLINE( 141)		::Sys_obj::println((HX_W(u"Crash dump sauvegard\u00e9 dans ",2b73,9d56) + ::haxe::io::Path_obj::normalize(path)));
HXLINE( 143)		::lime::app::Application_obj::current->_hx___window->alert(errMsg,HX_("Paff le loup!",4b,6a,d1,d7));
