...
HX_DEFINE_STACK_FRAME(_hx_pos_8e23e7423f533d70_582_new,"states.SongMetadata","new",0x9038fc22,"states.SongMetadata.new","states/FreeplayState.hx",582,0x1b2e20da)
namespace states{

void SongMetadata_obj::__construct(::String song,int week,::String songCharacter,int color){
            	HX_STACKFRAME(&_hx_pos_8e23e7423f533d70_582_new)
HXLINE( 588)		this->folder = HX_("",00,00,00,00);
HXLINE( 587)		this->color = -7179779;
HXLINE( 586)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 585)		this->week = 0;
HXLINE( 584)		this->songName = HX_("",00,00,00,00);
HXLINE( 592)		this->songName = song;
HXLINE( 593)		this->week = week;
HXLINE( 594)		this->songCharacter = songCharacter;
HXLINE( 595)		this->color = color;
HXLINE( 596)		this->folder = ::Paths_obj::currentModDirectory;
HXLINE( 597)		if (::hx::IsNull( this->folder )) {
HXLINE( 597)			this->folder = HX_("",00,00,00,00);
            		}
            	}
