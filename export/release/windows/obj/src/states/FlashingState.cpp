...
HX_DEFINE_STACK_FRAME(_hx_pos_3121e6e564aa22cb_14_new,"states.FlashingState","new",0x540715a5,"states.FlashingState.new","states/FlashingState.hx",14,0xc151f76c)
HX_LOCAL_STACK_FRAME(_hx_pos_3121e6e564aa22cb_20_create,"states.FlashingState","create",0x0390fad7,"states.FlashingState.create","states/FlashingState.hx",20,0xc151f76c)
HX_LOCAL_STACK_FRAME(_hx_pos_3121e6e564aa22cb_39_update,"states.FlashingState","update",0x0e8719e4,"states.FlashingState.update","states/FlashingState.hx",39,0xc151f76c)
HX_LOCAL_STACK_FRAME(_hx_pos_3121e6e564aa22cb_52_update,"states.FlashingState","update",0x0e8719e4,"states.FlashingState.update","states/FlashingState.hx",52,0xc151f76c)
HX_LOCAL_STACK_FRAME(_hx_pos_3121e6e564aa22cb_51_update,"states.FlashingState","update",0x0e8719e4,"states.FlashingState.update","states/FlashingState.hx",51,0xc151f76c)
HX_LOCAL_STACK_FRAME(_hx_pos_3121e6e564aa22cb_59_update,"states.FlashingState","update",0x0e8719e4,"states.FlashingState.update","states/FlashingState.hx",59,0xc151f76c)
HX_LOCAL_STACK_FRAME(_hx_pos_3121e6e564aa22cb_16_boot,"states.FlashingState","boot",0x2a44db4d,"states.FlashingState.boot","states/FlashingState.hx",16,0xc151f76c)
namespace states{
...
void FlashingState_obj::__construct( ::flixel::addons::transition::TransitionData TransIn, ::flixel::addons::transition::TransitionData TransOut){
            	HX_STACKFRAME(&_hx_pos_3121e6e564aa22cb_14_new)
...
void FlashingState_obj::create(){
            	HX_GC_STACKFRAME(&_hx_pos_3121e6e564aa22cb_20_create)
...
HXDLIN(  34)			 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::Y_dyn();
...
void FlashingState_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_3121e6e564aa22cb_39_update)
HXLINE(  40)		if (!(::states::FlashingState_obj::leftState)) {
...
HXLINE(  43)				::states::FlashingState_obj::leftState = true;
...
HXLINE(  46)				if (!(back)) {
            					...
            					void _hx_run( ::flixel::effects::FlxFlicker flk){
            						...
            						void _hx_run( ::flixel::util::FlxTimer tmr){
            							HX_GC_STACKFRAME(&_hx_pos_3121e6e564aa22cb_52_update)
HXLINE(  52)							::states::MusicBeatState_obj::switchState( ::TitleState_obj::__alloc( HX_CTX ,null(),null()));
            						}
            						HX_END_LOCAL_FUNC1((void))

            						HX_GC_STACKFRAME(&_hx_pos_3121e6e564aa22cb_51_update)
...
HXLINE(  50)					::flixel::effects::FlxFlicker_obj::flicker(this->warnText,1,((Float)0.1),false,true, ::Dynamic(new _hx_Closure_1()),null());
            					...
            					void _hx_run( ::flixel::tweens::FlxTween twn){
            						HX_GC_STACKFRAME(&_hx_pos_3121e6e564aa22cb_59_update)
HXLINE(  59)						::states::MusicBeatState_obj::switchState( ::TitleState_obj::__alloc( HX_CTX ,null(),null()));
            					}
            					HX_END_LOCAL_FUNC1((void))
...
{
{
            	HX_STACKFRAME(&_hx_pos_3121e6e564aa22cb_16_boot)
