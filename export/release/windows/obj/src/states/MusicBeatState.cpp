...
HX_LOCAL_STACK_FRAME(_hx_pos_08d8359b19576454_33_get_controls,"states.MusicBeatState","get_controls",0x0366454b,"states.MusicBeatState.get_controls","states/MusicBeatState.hx",33,0x86511dbb)
HX_LOCAL_STACK_FRAME(_hx_pos_08d8359b19576454_35_create,"states.MusicBeatState","create",0x582010c8,"states.MusicBeatState.create","states/MusicBeatState.hx",35,0x86511dbb)
HX_LOCAL_STACK_FRAME(_hx_pos_08d8359b19576454_47_update,"states.MusicBeatState","update",0x63162fd5,"states.MusicBeatState.update","states/MusicBeatState.hx",47,0x86511dbb)
HX_LOCAL_STACK_FRAME(_hx_pos_08d8359b19576454_74_updateSection,"states.MusicBeatState","updateSection",0xd0bfd290,"states.MusicBeatState.updateSection","states/MusicBeatState.hx",74,0x86511dbb)
HX_LOCAL_STACK_FRAME(_hx_pos_08d8359b19576454_86_rollbackSection,"states.MusicBeatState","rollbackSection",0x498c2ed5,"states.MusicBeatState.rollbackSection","states/MusicBeatState.hx",86,0x86511dbb)
HX_LOCAL_STACK_FRAME(_hx_pos_08d8359b19576454_107_updateBeat,"states.MusicBeatState","updateBeat",0x4ba04beb,"states.MusicBeatState.updateBeat","states/MusicBeatState.hx",107,0x86511dbb)
HX_LOCAL_STACK_FRAME(_hx_pos_08d8359b19576454_113_updateCurStep,"states.MusicBeatState","updateCurStep",0x2a592597,"states.MusicBeatState.updateCurStep","states/MusicBeatState.hx",113,0x86511dbb)
HX_LOCAL_STACK_FRAME(_hx_pos_08d8359b19576454_156_stepHit,"states.MusicBeatState","stepHit",0x33c5971b,"states.MusicBeatState.stepHit","states/MusicBeatState.hx",156,0x86511dbb)
HX_LOCAL_STACK_FRAME(_hx_pos_08d8359b19576454_161_beatHit,"states.MusicBeatState","beatHit",0x2688d331,"states.MusicBeatState.beatHit","states/MusicBeatState.hx",161,0x86511dbb)
HX_LOCAL_STACK_FRAME(_hx_pos_08d8359b19576454_166_sectionHit,"states.MusicBeatState","sectionHit",0x10a5753a,"states.MusicBeatState.sectionHit","states/MusicBeatState.hx",166,0x86511dbb)
HX_LOCAL_STACK_FRAME(_hx_pos_08d8359b19576454_171_getBeatsOnSection,"states.MusicBeatState","getBeatsOnSection",0x46b30973,"states.MusicBeatState.getBeatsOnSection","states/MusicBeatState.hx",171,0x86511dbb)
HX_LOCAL_STACK_FRAME(_hx_pos_08d8359b19576454_121_switchState,"states.MusicBeatState","switchState",0xc2435a31,"states.MusicBeatState.switchState","states/MusicBeatState.hx",121,0x86511dbb)
HX_LOCAL_STACK_FRAME(_hx_pos_08d8359b19576454_129_switchState,"states.MusicBeatState","switchState",0xc2435a31,"states.MusicBeatState.switchState","states/MusicBeatState.hx",129,0x86511dbb)
HX_LOCAL_STACK_FRAME(_hx_pos_08d8359b19576454_134_switchState,"states.MusicBeatState","switchState",0xc2435a31,"states.MusicBeatState.switchState","states/MusicBeatState.hx",134,0x86511dbb)
HX_LOCAL_STACK_FRAME(_hx_pos_08d8359b19576454_145_resetState,"states.MusicBeatState","resetState",0xbe7f2d8e,"states.MusicBeatState.resetState","states/MusicBeatState.hx",145,0x86511dbb)
HX_LOCAL_STACK_FRAME(_hx_pos_08d8359b19576454_148_getState,"states.MusicBeatState","getState",0x64ca3a67,"states.MusicBeatState.getState","states/MusicBeatState.hx",148,0x86511dbb)
namespace states{
...
bool MusicBeatState_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Controls MusicBeatState_obj::get_controls(){
            	HX_STACKFRAME(&_hx_pos_08d8359b19576454_33_get_controls)
...
void MusicBeatState_obj::create(){
            	HX_GC_STACKFRAME(&_hx_pos_08d8359b19576454_35_create)
HXLINE(  36)		::states::MusicBeatState_obj::camBeat = ::flixel::FlxG_obj::camera;
...
void MusicBeatState_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_08d8359b19576454_47_update)
...
void MusicBeatState_obj::updateSection(){
            	HX_STACKFRAME(&_hx_pos_08d8359b19576454_74_updateSection)
...
HXLINE(  80)			 ::states::MusicBeatState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
...
void MusicBeatState_obj::rollbackSection(){
            	HX_STACKFRAME(&_hx_pos_08d8359b19576454_86_rollbackSection)
...
HXLINE(  96)					 ::states::MusicBeatState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
...
void MusicBeatState_obj::updateBeat(){
            	HX_STACKFRAME(&_hx_pos_08d8359b19576454_107_updateBeat)
...
void MusicBeatState_obj::updateCurStep(){
            	HX_STACKFRAME(&_hx_pos_08d8359b19576454_113_updateCurStep)
...
void MusicBeatState_obj::stepHit(){
            	HX_STACKFRAME(&_hx_pos_08d8359b19576454_156_stepHit)
...
void MusicBeatState_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_08d8359b19576454_161_beatHit)
            	}
...
void MusicBeatState_obj::sectionHit(){
            	HX_STACKFRAME(&_hx_pos_08d8359b19576454_166_sectionHit)
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(MusicBeatState_obj,sectionHit,(void))
 ...
 ::Dynamic MusicBeatState_obj::getBeatsOnSection(){
            	HX_STACKFRAME(&_hx_pos_08d8359b19576454_171_getBeatsOnSection)
...
void MusicBeatState_obj::switchState( ::flixel::FlxState nextState){
            	HX_GC_STACKFRAME(&_hx_pos_08d8359b19576454_121_switchState)
HXLINE( 123)		 ::Dynamic curState = ::flixel::FlxG_obj::game->_state;
HXLINE( 124)		 ::states::MusicBeatState leState = ( ( ::states::MusicBeatState)(curState) );
...
HXLINE( 127)			if (::hx::IsInstanceEq( nextState,::flixel::FlxG_obj::game->_state )) {
            				...
            				void _hx_run(){
            					HX_GC_STACKFRAME(&_hx_pos_08d8359b19576454_129_switchState)
...
HXLINE( 128)				::CustomFadeTransition_obj::finishCallback =  ::Dynamic(new _hx_Closure_0());
            				...
            				void _hx_run(){
            					HX_GC_STACKFRAME(&_hx_pos_08d8359b19576454_134_switchState)
...
void MusicBeatState_obj::resetState(){
            	HX_STACKFRAME(&_hx_pos_08d8359b19576454_145_resetState)
HXDLIN( 145)		::states::MusicBeatState_obj::switchState(::flixel::FlxG_obj::game->_state);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(MusicBeatState_obj,resetState,(void))
 ...
 ::states::MusicBeatState MusicBeatState_obj::getState(){
            	HX_STACKFRAME(&_hx_pos_08d8359b19576454_148_getState)
HXLINE( 149)		 ::Dynamic curState = ::flixel::FlxG_obj::game->_state;
HXLINE( 150)		 ::states::MusicBeatState leState = ( ( ::states::MusicBeatState)(curState) );
