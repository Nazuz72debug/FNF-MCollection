...
HX_DEFINE_STACK_FRAME(_hx_pos_04e68d0d1b786c83_20_new,"states.AchievementsMenuState","new",0x8b29fbd4,"states.AchievementsMenuState.new","states/AchievementsMenuState.hx",20,0xe610951d)
HX_LOCAL_STACK_FRAME(_hx_pos_04e68d0d1b786c83_30_create,"states.AchievementsMenuState","create",0x93d2dc08,"states.AchievementsMenuState.create","states/AchievementsMenuState.hx",30,0xe610951d)
HX_LOCAL_STACK_FRAME(_hx_pos_04e68d0d1b786c83_77_update,"states.AchievementsMenuState","update",0x9ec8fb15,"states.AchievementsMenuState.update","states/AchievementsMenuState.hx",77,0xe610951d)
HX_LOCAL_STACK_FRAME(_hx_pos_04e68d0d1b786c83_93_changeSelection,"states.AchievementsMenuState","changeSelection",0xacd92230,"states.AchievementsMenuState.changeSelection","states/AchievementsMenuState.hx",93,0xe610951d)
HX_LOCAL_STACK_FRAME(_hx_pos_04e68d0d1b786c83_25_boot,"states.AchievementsMenuState","boot",0x31ab5e3e,"states.AchievementsMenuState.boot","states/AchievementsMenuState.hx",25,0xe610951d)
namespace states{
...
void AchievementsMenuState_obj::__construct( ::flixel::addons::transition::TransitionData TransIn, ::flixel::addons::transition::TransitionData TransOut){
            	HX_STACKFRAME(&_hx_pos_04e68d0d1b786c83_20_new)
...
void AchievementsMenuState_obj::create(){
            	HX_GC_STACKFRAME(&_hx_pos_04e68d0d1b786c83_30_create)
...
HXLINE(  38)		{
HXLINE(  38)			 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::XY_dyn();
HXDLIN(  38)			bool _hx_tmp;
HXDLIN(  38)			switch((int)(axes->_hx_getIndex())){
...
HXLINE(  57)				optionText1->targetY = (i - ::states::AchievementsMenuState_obj::curSelected);
...
void AchievementsMenuState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_04e68d0d1b786c83_77_update)
...
HXLINE(  89)			::states::MusicBeatState_obj::switchState( ::states::MainMenuState_obj::__alloc( HX_CTX ,null(),null()));
            		}
            	}
...
void AchievementsMenuState_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_04e68d0d1b786c83_93_changeSelection)
HXLINE(  94)		 ::Dynamic _hx_tmp = ::hx::ClassOf< ::states::AchievementsMenuState >();
HXDLIN(  94)		::states::AchievementsMenuState_obj::curSelected = (::states::AchievementsMenuState_obj::curSelected + change);
HXLINE(  95)		if ((::states::AchievementsMenuState_obj::curSelected < 0)) {
HXLINE(  96)			::states::AchievementsMenuState_obj::curSelected = (this->options->length - 1);
            		}
HXLINE(  97)		if ((::states::AchievementsMenuState_obj::curSelected >= this->options->length)) {
HXLINE(  98)			::states::AchievementsMenuState_obj::curSelected = 0;
            		}
...
HXDLIN( 102)				_g = (_g + 1);
HXLINE( 103)				item->targetY = (bullShit - ::states::AchievementsMenuState_obj::curSelected);
...
HXLINE( 114)				if ((i == ::states::AchievementsMenuState_obj::curSelected)) {
HXLINE( 115)					this->achievementArray->__get(i).StaticCast<  ::AttachedAchievement >()->set_alpha(( (Float)(1) ));
            				}
            			}
            		}
HXLINE( 118)		this->descText->set_text(( (::String)(::Achievements_obj::achievementsStuff->__get(this->achievementIndex->__get(::states::AchievementsMenuState_obj::curSelected))->__GetItem(1)) ));
...
{
{
            	HX_STACKFRAME(&_hx_pos_04e68d0d1b786c83_25_boot)
