...
HX_LOCAL_STACK_FRAME(_hx_pos_b16413162a1a88c5_38_stat,"sys.FileSystem","stat",0xa630df16,"sys.FileSystem.stat","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",38,0xcfe7676a)
HX_LOCAL_STACK_FRAME(_hx_pos_b16413162a1a88c5_75_isDirectory,"sys.FileSystem","isDirectory",0x6c577a21,"sys.FileSystem.isDirectory","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",75,0xcfe7676a)
HX_LOCAL_STACK_FRAME(_hx_pos_b16413162a1a88c5_78_createDirectory,"sys.FileSystem","createDirectory",0x63bad3cf,"sys.FileSystem.createDirectory","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",78,0xcfe7676a)
HX_LOCAL_STACK_FRAME(_hx_pos_b16413162a1a88c5_93_deleteFile,"sys.FileSystem","deleteFile",0x4bd48509,"sys.FileSystem.deleteFile","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",93,0xcfe7676a)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FileSystem_obj,exists,return )
 ...
 ::Dynamic FileSystem_obj::stat(::String path){
            	HX_STACKFRAME(&_hx_pos_b16413162a1a88c5_38_stat)
HXLINE(  39)		::String s;
HXDLIN(  39)		bool s1;
...
bool FileSystem_obj::isDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_b16413162a1a88c5_75_isDirectory)
...
void FileSystem_obj::createDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_b16413162a1a88c5_78_createDirectory)
...
void FileSystem_obj::deleteFile(::String path){
            	HX_STACKFRAME(&_hx_pos_b16413162a1a88c5_93_deleteFile)
