...
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_252_reloadNote,"Note","reloadNote",0x1599eec7,"Note.reloadNote","Note.hx",252,0x1a8855ec)
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_323_loadNoteAnims,"Note","loadNoteAnims",0x493f5f8e,"Note.loadNoteAnims","Note.hx",323,0x1a8855ec)
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_338_loadPixelNoteAnims,"Note","loadPixelNoteAnims",0xefd7042c,"Note.loadPixelNoteAnims","Note.hx",338,0x1a8855ec)
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_347_update,"Note","update",0xca3a1ee5,"Note.update","Note.hx",347,0x1a8855ec)
...
HXLINE( 251)		this->originalHeightForCalcs = ((Float)6);
HXLINE( 250)		this->lastNoteScaleToo = ((Float)1);
HXLINE( 249)		this->lastNoteOffsetXForPixelAutoAdjusting = ((Float)0);
...
HXLINE(  64)		this->pixelInt = ::Array_obj< int >::fromData( _hx_array_data_33e34412_1,4);
HXLINE(  63)		this->colArray = ::Array_obj< ::String >::fromData( _hx_array_data_33e34412_2,4);
HXLINE(  59)		this->lowPriority = false;
HXLINE(  58)		this->lateHitMult = ((Float)1);
HXLINE(  57)		this->earlyHitMult = ((Float)0.5);
HXLINE(  56)		this->gfNote = false;
HXLINE(  55)		this->animSuffix = HX_("",00,00,00,00);
...
HXLINE(  41)		this->blockHit = false;
HXLINE(  39)		this->tail = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  37)		this->spawned = false;
HXLINE(  33)		this->noteWasHit = false;
HXLINE(  32)		this->hitByOpponent = false;
HXLINE(  31)		this->ignoreNote = false;
HXLINE(  30)		this->wasGoodHit = false;
HXLINE(  29)		this->tooLate = false;
HXLINE(  28)		this->canBeHit = false;
HXLINE(  27)		this->noteData = 0;
HXLINE(  26)		this->mustPress = false;
HXLINE(  25)		this->strumTime = ((Float)0);
HXLINE(  23)		this->extraData =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
...
HXLINE( 192)				animToPlay = this->colArray->__get(::hx::Mod(noteData,4));
HXLINE( 193)				this->animation->play((animToPlay + HX_("Scroll",2d,4c,f9,7b)),null(),null(),null());
            			}
            		}
HXLINE( 199)		if (::hx::IsNotNull( prevNote )) {
HXLINE( 200)			prevNote->nextNote = ::hx::ObjectPtr<OBJ_>(this);
            		}
HXLINE( 202)		bool _hx_tmp1;
HXDLIN( 202)		if (this->isSustainNote) {
HXLINE( 202)			_hx_tmp1 = ::hx::IsNotNull( prevNote );
            		}
            		else {
HXLINE( 202)			_hx_tmp1 = false;
            		}
HXDLIN( 202)		if (_hx_tmp1) {
HXLINE( 204)			this->set_alpha(((Float)0.6));
HXLINE( 205)			this->multAlpha = ((Float)0.6);
HXLINE( 206)			this->hitsoundDisabled = true;
HXLINE( 207)			if (::ClientPrefs_obj::downScroll) {
HXLINE( 207)				this->set_flipY(true);
            			}
HXLINE( 209)			 ::Note _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 209)			Float _hx_tmp1 = _hx_tmp->offsetX;
HXDLIN( 209)			_hx_tmp->offsetX = (_hx_tmp1 + (this->get_width() / ( (Float)(2) )));
HXLINE( 210)			this->copyAngle = false;
HXLINE( 212)			this->animation->play((this->colArray->__get(::hx::Mod(noteData,4)) + HX_("holdend",fc,4b,02,b8)),null(),null(),null());
HXLINE( 214)			this->updateHitbox();
HXLINE( 216)			 ::Note _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 216)			Float _hx_tmp3 = _hx_tmp2->offsetX;
HXDLIN( 216)			_hx_tmp2->offsetX = (_hx_tmp3 - (this->get_width() / ( (Float)(2) )));
HXLINE( 218)			if (::PlayState_obj::isPixelStage) {
HXLINE( 219)				 ::Note _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 219)				_hx_tmp->offsetX = (_hx_tmp->offsetX + 30);
            			}
HXLINE( 221)			if (prevNote->isSustainNote) {
HXLINE( 223)				prevNote->animation->play((this->colArray->__get(::hx::Mod(prevNote->noteData,4)) + HX_("hold",3f,c9,12,45)),null(),null(),null());
HXLINE( 225)				 ::flixel::math::FlxPoint fh = prevNote->scale;
HXDLIN( 225)				fh->set_y((fh->y * ((::Conductor_obj::stepCrochet / ( (Float)(100) )) * ((Float)1.05))));
HXLINE( 226)				if (::hx::IsNotNull( ::PlayState_obj::instance )) {
HXLINE( 228)					 ::flixel::math::FlxPoint fh = prevNote->scale;
HXDLIN( 228)					fh->set_y((fh->y * ::PlayState_obj::instance->songSpeed));
            				}
HXLINE( 231)				if (::PlayState_obj::isPixelStage) {
HXLINE( 232)					 ::flixel::math::FlxPoint fh = prevNote->scale;
HXDLIN( 232)					fh->set_y((fh->y * ((Float)1.19)));
HXLINE( 233)					 ::flixel::math::FlxPoint fh1 = prevNote->scale;
HXDLIN( 233)					Float fh2 = fh1->y;
HXDLIN( 233)					fh1->set_y((fh2 * (( (Float)(6) ) / this->get_height())));
            				}
HXLINE( 235)				prevNote->updateHitbox();
            			}
HXLINE( 239)			if (::PlayState_obj::isPixelStage) {
HXLINE( 240)				 ::flixel::math::FlxPoint fh = this->scale;
HXDLIN( 240)				fh->set_y((fh->y * ::PlayState_obj::daPixelZoom));
HXLINE( 241)				this->updateHitbox();
            			}
            		}
            		else {
HXLINE( 243)			if (!(this->isSustainNote)) {
HXLINE( 244)				this->earlyHitMult = ( (Float)(1) );
            			}
            		}
HXLINE( 246)		this->set_x((this->x + this->offsetX));
            	}
...
void Note_obj::reloadNote(::String __o_prefix,::String __o_texture,::String __o_suffix){
            	...
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_252_reloadNote)
HXLINE( 253)		if (::hx::IsNull( prefix )) {
HXLINE( 253)			prefix = HX_("",00,00,00,00);
            		}
HXLINE( 254)		if (::hx::IsNull( texture )) {
HXLINE( 254)			texture = HX_("",00,00,00,00);
            		}
HXLINE( 255)		if (::hx::IsNull( suffix )) {
HXLINE( 255)			suffix = HX_("",00,00,00,00);
            		}
HXLINE( 257)		::String skin = texture;
HXLINE( 258)		if ((texture.length < 1)) {
HXLINE( 259)			skin = ( (::String)(::PlayState_obj::SONG->__Field(HX_("arrowSkin",e6,d4,f8,07),::hx::paccDynamic)) );
HXLINE( 260)			bool _hx_tmp;
HXDLIN( 260)			if (::hx::IsNotNull( skin )) {
HXLINE( 260)				_hx_tmp = (skin.length < 1);
            			}
            			else {
HXLINE( 260)				_hx_tmp = true;
            			}
HXDLIN( 260)			if (_hx_tmp) {
HXLINE( 261)				skin = HX_("NOTE_assets",70,3c,09,f7);
            			}
            		}
HXLINE( 265)		::String animName = null();
HXLINE( 266)		if (::hx::IsNotNull( this->animation->_curAnim )) {
HXLINE( 267)			animName = this->animation->_curAnim->name;
            		}
HXLINE( 270)		::Array< ::String > arraySkin = skin.split(HX_("/",2f,00,00,00));
HXLINE( 271)		arraySkin[(arraySkin->length - 1)] = ((prefix + arraySkin->__get((arraySkin->length - 1))) + suffix);
HXLINE( 273)		Float lastScaleY = this->scale->y;
HXLINE( 274)		::String blahblah = arraySkin->join(HX_("/",2f,00,00,00));
HXLINE( 275)		if (::PlayState_obj::isPixelStage) {
HXLINE( 276)			if (this->isSustainNote) {
HXLINE( 277)				::String library = null();
HXDLIN( 277)				 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(((HX_("pixelUI/",95,50,4f,7e) + blahblah) + HX_("ENDS",38,24,d7,2d)),library);
HXDLIN( 277)				this->loadGraphic(returnAsset,null(),null(),null(),null(),null());
HXLINE( 278)				this->set_width((this->get_width() / ( (Float)(4) )));
HXLINE( 279)				this->set_height((this->get_height() / ( (Float)(2) )));
HXLINE( 280)				this->originalHeightForCalcs = this->get_height();
HXLINE( 281)				::String library1 = null();
HXDLIN( 281)				 ::flixel::graphics::FlxGraphic returnAsset1 = ::Paths_obj::returnGraphic(((HX_("pixelUI/",95,50,4f,7e) + blahblah) + HX_("ENDS",38,24,d7,2d)),library1);
...
HXLINE( 283)				::String library = null();
HXDLIN( 283)				 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic((HX_("pixelUI/",95,50,4f,7e) + blahblah),library);
HXDLIN( 283)				this->loadGraphic(returnAsset,null(),null(),null(),null(),null());
HXLINE( 284)				this->set_width((this->get_width() / ( (Float)(4) )));
HXLINE( 285)				this->set_height((this->get_height() / ( (Float)(5) )));
HXLINE( 286)				::String library1 = null();
HXDLIN( 286)				 ::flixel::graphics::FlxGraphic returnAsset1 = ::Paths_obj::returnGraphic((HX_("pixelUI/",95,50,4f,7e) + blahblah),library1);
HXDLIN( 286)				int _hx_tmp = ::Math_obj::floor(this->get_width());
HXDLIN( 286)				this->loadGraphic(returnAsset1,true,_hx_tmp,::Math_obj::floor(this->get_height()),null(),null());
            			}
HXLINE( 288)			Float _hx_tmp = this->get_width();
HXDLIN( 288)			this->setGraphicSize(::Std_obj::_hx_int((_hx_tmp * ::PlayState_obj::daPixelZoom)),null());
HXLINE( 289)			this->loadPixelNoteAnims();
HXLINE( 290)			this->set_antialiasing(false);
HXLINE( 292)			if (this->isSustainNote) {
HXLINE( 293)				 ::Note _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 293)				_hx_tmp->offsetX = (_hx_tmp->offsetX + this->lastNoteOffsetXForPixelAutoAdjusting);
HXLINE( 294)				Float _hx_tmp1 = (this->get_width() - ( (Float)(7) ));
HXDLIN( 294)				this->lastNoteOffsetXForPixelAutoAdjusting = (_hx_tmp1 * (::PlayState_obj::daPixelZoom / ( (Float)(2) )));
HXLINE( 295)				 ::Note _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 295)				_hx_tmp2->offsetX = (_hx_tmp2->offsetX - this->lastNoteOffsetXForPixelAutoAdjusting);
            			}
            		}
            		else {
HXLINE( 305)			::String library = null();
HXDLIN( 305)			 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::returnGraphic(blahblah,null());
HXDLIN( 305)			bool xmlExists = false;
HXDLIN( 305)			if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + blahblah) + HX_(".xml",69,3e,c3,1e))))) {
HXLINE( 305)				xmlExists = true;
            			}
HXDLIN( 305)			 ::Dynamic _hx_tmp;
HXDLIN( 305)			if (::hx::IsNotNull( imageLoaded )) {
HXLINE( 305)				_hx_tmp = imageLoaded;
            			}
            			else {
HXLINE( 305)				 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(blahblah,library);
HXDLIN( 305)				_hx_tmp = returnAsset;
            			}
HXDLIN( 305)			::String _hx_tmp1;
HXDLIN( 305)			if (xmlExists) {
HXLINE( 305)				_hx_tmp1 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + blahblah) + HX_(".xml",69,3e,c3,1e))));
            			}
            			else {
HXLINE( 305)				_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + blahblah) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            			}
HXDLIN( 305)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,_hx_tmp1));
HXLINE( 306)			this->loadNoteAnims();
HXLINE( 307)			this->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
            		}
HXLINE( 309)		if (this->isSustainNote) {
HXLINE( 310)			this->scale->set_y(lastScaleY);
            		}
HXLINE( 312)		this->updateHitbox();
HXLINE( 314)		if (::hx::IsNotNull( animName )) {
HXLINE( 315)			this->animation->play(animName,true,null(),null());
            		}
HXLINE( 317)		if (this->inEditor) {
HXLINE( 318)			this->setGraphicSize(::editors::ChartingState_obj::GRID_SIZE,::editors::ChartingState_obj::GRID_SIZE);
...
void Note_obj::loadNoteAnims(){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_323_loadNoteAnims)
HXLINE( 324)		this->animation->addByPrefix((this->colArray->__get(this->noteData) + HX_("Scroll",2d,4c,f9,7b)),(this->colArray->__get(this->noteData) + HX_("0",30,00,00,00)),null(),null(),null(),null());
HXLINE( 326)		if (this->isSustainNote) {
HXLINE( 328)			this->animation->addByPrefix(HX_("purpleholdend",40,d5,15,5b),HX_("pruple end hold",6e,7c,17,3a),null(),null(),null(),null());
HXLINE( 329)			this->animation->addByPrefix((this->colArray->__get(this->noteData) + HX_("holdend",fc,4b,02,b8)),(this->colArray->__get(this->noteData) + HX_(" hold end",9a,cc,8a,7a)),null(),null(),null(),null());
HXLINE( 330)			this->animation->addByPrefix((this->colArray->__get(this->noteData) + HX_("hold",3f,c9,12,45)),(this->colArray->__get(this->noteData) + HX_(" hold piece",6d,10,66,9e)),null(),null(),null(),null());
            		}
HXLINE( 333)		this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ((Float)0.7))),null());
...
void Note_obj::loadPixelNoteAnims(){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_338_loadPixelNoteAnims)
HXDLIN( 338)		if (this->isSustainNote) {
HXLINE( 339)			this->animation->add((this->colArray->__get(this->noteData) + HX_("holdend",fc,4b,02,b8)),::Array_obj< int >::__new(1)->init(0,(this->pixelInt->__get(this->noteData) + 4)),null(),null(),null(),null());
HXLINE( 340)			this->animation->add((this->colArray->__get(this->noteData) + HX_("hold",3f,c9,12,45)),::Array_obj< int >::__new(1)->init(0,this->pixelInt->__get(this->noteData)),null(),null(),null(),null());
            		}
            		else {
HXLINE( 342)			this->animation->add((this->colArray->__get(this->noteData) + HX_("Scroll",2d,4c,f9,7b)),::Array_obj< int >::__new(1)->init(0,(this->pixelInt->__get(this->noteData) + 4)),null(),null(),null(),null());
            		}
            	}
...
void Note_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_347_update)
HXLINE( 348)		this->super::update(elapsed);
HXLINE( 350)		if (this->mustPress) {
HXLINE( 353)			bool _hx_tmp;
HXDLIN( 353)			if ((this->strumTime > (::Conductor_obj::songPosition - (::Conductor_obj::safeZoneOffset * this->lateHitMult)))) {
HXLINE( 353)				_hx_tmp = (this->strumTime < (::Conductor_obj::songPosition + (::Conductor_obj::safeZoneOffset * this->earlyHitMult)));
            			}
            			else {
HXLINE( 353)				_hx_tmp = false;
            			}
HXDLIN( 353)			if (_hx_tmp) {
HXLINE( 355)				this->canBeHit = true;
            			}
            			else {
HXLINE( 357)				this->canBeHit = false;
            			}
HXLINE( 359)			bool _hx_tmp1;
HXDLIN( 359)			if ((this->strumTime < (::Conductor_obj::songPosition - ::Conductor_obj::safeZoneOffset))) {
HXLINE( 359)				_hx_tmp1 = !(this->wasGoodHit);
            			}
            			else {
HXLINE( 359)				_hx_tmp1 = false;
            			}
HXDLIN( 359)			if (_hx_tmp1) {
HXLINE( 360)				this->tooLate = true;
            			}
            		}
            		else {
HXLINE( 364)			this->canBeHit = false;
HXLINE( 366)			if ((this->strumTime < (::Conductor_obj::songPosition + (::Conductor_obj::safeZoneOffset * this->earlyHitMult)))) {
HXLINE( 368)				bool _hx_tmp;
HXDLIN( 368)				bool _hx_tmp1;
HXDLIN( 368)				if (this->isSustainNote) {
HXLINE( 368)					_hx_tmp1 = this->prevNote->wasGoodHit;
            				}
            				else {
HXLINE( 368)					_hx_tmp1 = false;
            				}
HXDLIN( 368)				if (!(_hx_tmp1)) {
HXLINE( 368)					_hx_tmp = (this->strumTime <= ::Conductor_obj::songPosition);
            				}
            				else {
HXLINE( 368)					_hx_tmp = true;
            				}
HXDLIN( 368)				if (_hx_tmp) {
HXLINE( 369)					this->wasGoodHit = true;
            				}
            			}
            		}
HXLINE( 373)		bool _hx_tmp;
HXDLIN( 373)		if (this->tooLate) {
HXLINE( 373)			_hx_tmp = !(this->inEditor);
            		}
            		else {
HXLINE( 373)			_hx_tmp = false;
            		}
HXDLIN( 373)		if (_hx_tmp) {
HXLINE( 375)			if ((this->alpha > ((Float)0.3))) {
HXLINE( 376)				this->set_alpha(((Float)0.3));
            			}
            		}
            	}
