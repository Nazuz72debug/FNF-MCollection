...
HX_LOCAL_STACK_FRAME(_hx_pos_3695599a5ed8f86c_28_print,"Sys","print",0x483745ec,"Sys.print","D:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",28,0x11cfd118)
HX_LOCAL_STACK_FRAME(_hx_pos_3695599a5ed8f86c_32_println,"Sys","println",0x3905f76e,"Sys.println","D:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",32,0x11cfd118)
HX_LOCAL_STACK_FRAME(_hx_pos_3695599a5ed8f86c_56_args,"Sys","args",0xeaeddc7e,"Sys.args","D:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",56,0x11cfd118)
HX_LOCAL_STACK_FRAME(_hx_pos_3695599a5ed8f86c_59_getEnv,"Sys","getEnv",0xd9e05658,"Sys.getEnv","D:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",59,0x11cfd118)
HX_LOCAL_STACK_FRAME(_hx_pos_3695599a5ed8f86c_71_sleep,"Sys","sleep",0xfe70aad6,"Sys.sleep","D:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",71,0x11cfd118)
HX_LOCAL_STACK_FRAME(_hx_pos_3695599a5ed8f86c_79_getCwd,"Sys","getCwd",0xd9ded99b,"Sys.getCwd","D:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",79,0x11cfd118)
HX_LOCAL_STACK_FRAME(_hx_pos_3695599a5ed8f86c_83_setCwd,"Sys","setCwd",0xa6272e0f,"Sys.setCwd","D:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",83,0x11cfd118)
HX_LOCAL_STACK_FRAME(_hx_pos_3695599a5ed8f86c_87_systemName,"Sys","systemName",0xbea5b6bb,"Sys.systemName","D:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",87,0x11cfd118)
HX_LOCAL_STACK_FRAME(_hx_pos_3695599a5ed8f86c_91_command,"Sys","command",0x363f8cca,"Sys.command","D:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",91,0x11cfd118)
HX_LOCAL_STACK_FRAME(_hx_pos_3695599a5ed8f86c_109_exit,"Sys","exit",0xed97463f,"Sys.exit","D:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",109,0x11cfd118)
HX_LOCAL_STACK_FRAME(_hx_pos_3695599a5ed8f86c_113_time,"Sys","time",0xf7761b2e,"Sys.time","D:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",113,0x11cfd118)
...
void Sys_obj::print( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_3695599a5ed8f86c_28_print)
...
void Sys_obj::println( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_3695599a5ed8f86c_32_println)
...
::Array< ::String > Sys_obj::args(){
            	HX_STACKFRAME(&_hx_pos_3695599a5ed8f86c_56_args)
...
::String Sys_obj::getEnv(::String s){
            	HX_STACKFRAME(&_hx_pos_3695599a5ed8f86c_59_getEnv)
...
void Sys_obj::sleep(Float seconds){
            	HX_STACKFRAME(&_hx_pos_3695599a5ed8f86c_71_sleep)
...
::String Sys_obj::getCwd(){
            	HX_STACKFRAME(&_hx_pos_3695599a5ed8f86c_79_getCwd)
...
void Sys_obj::setCwd(::String s){
            	HX_STACKFRAME(&_hx_pos_3695599a5ed8f86c_83_setCwd)
...
::String Sys_obj::systemName(){
            	HX_STACKFRAME(&_hx_pos_3695599a5ed8f86c_87_systemName)
...
int Sys_obj::command(::String cmd,::Array< ::String > args){
            	HX_STACKFRAME(&_hx_pos_3695599a5ed8f86c_91_command)
...
void Sys_obj::exit(int code){
            	HX_STACKFRAME(&_hx_pos_3695599a5ed8f86c_109_exit)
...
Float Sys_obj::time(){
            	HX_STACKFRAME(&_hx_pos_3695599a5ed8f86c_113_time)
