...
HX_DEFINE_STACK_FRAME(_hx_pos_7f2779d0a0ea7f18_522_new,"haxe._Unserializer.NullResolver","new",0x49a2304b,"haxe._Unserializer.NullResolver.new","D:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",522,0xb0683622)
HX_LOCAL_STACK_FRAME(_hx_pos_7f2779d0a0ea7f18_525_resolveClass,"haxe._Unserializer.NullResolver","resolveClass",0xc4a78861,"haxe._Unserializer.NullResolver.resolveClass","D:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",525,0xb0683622)
HX_LOCAL_STACK_FRAME(_hx_pos_7f2779d0a0ea7f18_528_resolveEnum,"haxe._Unserializer.NullResolver","resolveEnum",0x5f3252f8,"haxe._Unserializer.NullResolver.resolveEnum","D:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",528,0xb0683622)
namespace haxe{
namespace _Unserializer{

void NullResolver_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_7f2779d0a0ea7f18_522_new)
            	}
...
::hx::Class NullResolver_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_7f2779d0a0ea7f18_525_resolveClass)
...
::hx::Class NullResolver_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_7f2779d0a0ea7f18_528_resolveEnum)
