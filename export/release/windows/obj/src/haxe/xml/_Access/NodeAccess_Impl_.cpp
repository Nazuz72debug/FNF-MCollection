...
HX_LOCAL_STACK_FRAME(_hx_pos_f3fc8ca860e0849e_27_resolve,"haxe.xml._Access.NodeAccess_Impl_","resolve",0xc66a9d2e,"haxe.xml._Access.NodeAccess_Impl_.resolve","D:\\HaxeToolkit\\haxe\\std/haxe/xml/Access.hx",27,0x53774111)
namespace haxe{
namespace xml{
namespace _Access{
...
bool NodeAccess_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Xml NodeAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_f3fc8ca860e0849e_27_resolve)
