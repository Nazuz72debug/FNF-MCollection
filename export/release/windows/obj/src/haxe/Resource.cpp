...
HX_LOCAL_STACK_FRAME(_hx_pos_e67ef3795e920047_35_getBytes,"haxe.Resource","getBytes",0x9bc1712d,"haxe.Resource.getBytes","D:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Resource.hx",35,0x5fb25fce)
namespace haxe{
...
bool Resource_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes Resource_obj::getBytes(::String name){
            	HX_STACKFRAME(&_hx_pos_e67ef3795e920047_35_getBytes)
