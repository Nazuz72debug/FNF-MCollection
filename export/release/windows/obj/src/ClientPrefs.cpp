...
HXLINE( 248)			{
HXLINE( 248)				::Dynamic map = savedMap;
HXDLIN( 248)				::Dynamic _g_map = map;
HXDLIN( 248)				 ::Dynamic _g_keys = ::haxe::IMap_obj::keys(map);
HXDLIN( 248)				while(( (bool)(_g_keys->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 248)					::String key = ( (::String)(_g_keys->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXDLIN( 248)					 ::Dynamic _g1_value = ::haxe::IMap_obj::get(_g_map,key);
HXDLIN( 248)					::String _g1_key = key;
HXDLIN( 248)					::String name = _g1_key;
HXDLIN( 248)					 ::Dynamic value = _g1_value;
...
HXLINE( 271)		save->bind(HX_("controls_v2",65,e4,a2,26),HX_("ninjamuffin99",f7,4c,e5,00));
...
HXLINE( 274)			{
HXLINE( 274)				::Dynamic map = loadedControls;
HXDLIN( 274)				::Dynamic _g_map = map;
HXDLIN( 274)				 ::Dynamic _g_keys = ::haxe::IMap_obj::keys(map);
HXDLIN( 274)				while(( (bool)(_g_keys->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 274)					::String key = ( (::String)(_g_keys->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXDLIN( 274)					::Array< int > _g1_value = ( (::Array< int >)(::haxe::IMap_obj::get(_g_map,key)) );
HXDLIN( 274)					::String _g1_key = key;
HXDLIN( 274)					::String control = _g1_key;
HXDLIN( 274)					::Array< int > keys = _g1_value;
