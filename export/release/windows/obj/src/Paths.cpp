...
HXLINE( 362)		::haxe::Log_obj::trace(HX_("Fais chier, ce con il et null, null germain",75,f0,8d,c5),::hx::SourceInfo(HX_("source/Paths.hx",64,c7,bd,1c),362,HX_("Paths",0e,7b,84,50),HX_("returnGraphic",d8,d3,95,0b)));
...
HXDLIN( 488)									 ::Dynamic e = ::haxe::Exception_obj::caught(_g)->unwrap();
